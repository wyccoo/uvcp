...
from tools.data_converter import dair_converter as dair_converter
...
def get_gt(info):
    ...
    Returns:
        ...
        Tensor: GT labels.
    """
    ego2global_rotation = info['cams']['VEHICLE']['ego2global_rotation']
    ego2global_translation = info['cams']['VEHICLE'][
...
def dair_data_prep(root_path, info_prefix, version, max_sweeps=10):
    """Prepare data related to nuScenes dataset.
    ...
    Args:
        ...
        max_sweeps (int, optional): Number of input consecutive frames.
            Default: 10
    """
    dair_converter.create_dair_infos(
        root_path, info_prefix, version=version, max_sweeps=max_sweeps)
...
if __name__ == '__main__':
    dataset = 'dair-v2x'
    version = 'v1.14'
    train_version = 'dair-v2x'
    root_path = 'data/cooperative-vehicle-infrastructure/'
