...
class NuScenesDataset(Custom3DDataset):
        ...
        if self.modality['use_camera']:
            if self.img_info_prototype == 'mmcv':
                ...
                for cam_type, cam_info in info['cams'].items():
                    ...
                    lidar2cam_r = cam_info['sensor2lidar_rotation']
    ...
    def _evaluate_single(self,
        ...
        if self.version == "dair-v2x":
            ...
            output_dir = osp.join(*osp.split(result_path)[:-1])
            nusc = NuScenes(
                version=self.version, dataroot='../autodl-tmp/cooperative-vehicle-infrastructure/', verbose=False)
            eval_set_map = {
                'v1.0-mini': 'mini_val',
                'v1.0-trainval': 'val',
                'v1.14-trainval':'vals',
    ...
    def evaluate(self,
        ...
        if isinstance(result_files, dict):
            ...
            for name in result_names:
                ...
                ret_dict = self._evaluate_single(result_files[name], gt_path)
