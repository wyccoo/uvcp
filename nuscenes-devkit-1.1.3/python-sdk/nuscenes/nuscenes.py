...
class NuScenes:
    ...
    def __init__(self,
                 ...
                 dataroot: str = '../autodl-tmp/cooperative-vehicle-infrastructure',
                 verbose: bool = True,
    ...
    def box_velocity(self, sample_annotation_token: str, max_time_diff: float = 1.5) -> np.ndarray:
        ...
        time_last = 1e-7 * self.get('sample', last['sample_token'])['timestamp']
        time_first = 1e-7 * self.get('sample', first['sample_token'])['timestamp']
    ...
    def render_sample(self,
        ...
        for (_, sd_token), ax in zip(camera_data.items(), axes.flatten()[num_radar_plots + num_lidar_plots:]):
            if not show_lidarseg:
                ...
                valid_channels = ['VEHICLE', 'UAV-1', 'UAV-2']
