...
trains = \
    [
          'scene-1-1', 'scene-1-2', 'scene-1-3', 'scene-1-4', 'scene-1-5', 'scene-1-6', 'scene-1-7', 'scene-1-8',
          'scene-1-9', 'scene-2-1', 'scene-2-2', 'scene-2-3', 'scene-2-4', 'scene-2-6', 'scene-2-7', 'scene-2-8',
          'scene-2-9', 'scene-2-10','scene-3-1', 'scene-3-2', 'scene-3-3', 'scene-3-4', 'scene-3-5', 'scene-3-7',
          'scene-3-8', 'scene-3-9', 'scene-3-10','scene-4-1', 'scene-4-2', 'scene-4-3', 'scene-4-4', 'scene-4-5',
          'scene-4-6', 'scene-4-8', 'scene-4-9', 'scene-4-10','scene-5-1', 'scene-5-2', 'scene-5-3', 'scene-5-4',
          'scene-5-5', 'scene-5-6', 'scene-5-7', 'scene-5-9', 'scene-5-10','scene-6-1', 'scene-6-2', 'scene-6-3',
          'scene-6-4', 'scene-6-5', 'scene-6-6', 'scene-6-7', 'scene-6-8', 'scene-6-10','scene-7-1', 'scene-7-2',
          'scene-7-3', 'scene-7-4', 'scene-7-5', 'scene-7-6', 'scene-7-7', 'scene-7-8', 'scene-7-9',
          'scene-1-11', 'scene-1-12', 'scene-1-13', 'scene-1-14', 'scene-1-15', 'scene-1-16', 'scene-1-17', 'scene-1-18',
          'scene-2-15', 'scene-1-19', 'scene-3-20', 'scene-4-11', 'scene-5-15', 'scene-6-19', 'scene-7-20', 'scene-8-5',
          'scene-2-12', 'scene-2-13', 'scene-2-14', 'scene-2-16', 'scene-2-17', 'scene-2-18', 'scene-2-19', 'scene-2-20',
          'scene-3-11', 'scene-3-12', 'scene-3-13', 'scene-3-14', 'scene-3-15', 'scene-3-17', 'scene-3-18', 'scene-3-19',
          'scene-4-12', 'scene-4-13', 'scene-4-14', 'scene-4-15', 'scene-4-16', 'scene-4-18', 'scene-4-19', 'scene-4-20',
          'scene-5-11', 'scene-5-12', 'scene-5-13', 'scene-5-14', 'scene-5-16', 'scene-5-17', 'scene-5-19', 'scene-5-20',
          'scene-6-11', 'scene-6-12', 'scene-6-14', 'scene-6-15', 'scene-6-16', 'scene-6-17', 'scene-6-18', 'scene-6-20',
          'scene-7-11', 'scene-7-12', 'scene-7-13', 'scene-7-14', 'scene-7-16', 'scene-7-17', 'scene-7-18', 'scene-7-19',
          'scene-8-11', 'scene-8-12', 'scene-8-13', 'scene-8-14', 'scene-8-16', 'scene-8-17', 'scene-8-18', 'scene-8-19',
          'scene-8-20'
    ]
vals = \
    [
        'scene-2-5', 'scene-1-10', 'scene-3-6', 'scene-4-7', 'scene-5-8', 'scene-6-9', 'scene-7-10',
        'scene-2-11','scene-1-20','scene-3-16', 'scene-4-17', 'scene-5-18', 'scene-6-13', 'scene-7-15',
        'scene-8-10','scene-8-15']
# trains = \
#     [
#         'scene-1-1', 'scene-1-2', 'scene-1-3', 'scene-1-4', 'scene-1-5', 'scene-1-6', 'scene-1-7', 'scene-1-8',
#         'scene-2-2', 'scene-2-3', 'scene-2-4', 'scene-2-6', 'scene-2-7', 'scene-2-8', 'scene-2-9', 'scene-2-10',
#         'scene-3-1', 'scene-3-2', 'scene-3-3', 'scene-3-4', 'scene-3-5', 'scene-3-7', 'scene-3-8', 'scene-3-9',
#         'scene-4-2', 'scene-4-3', 'scene-4-4', 'scene-4-5', 'scene-4-6', 'scene-4-8', 'scene-4-9', 'scene-4-10',
#         'scene-5-1', 'scene-5-2', 'scene-5-3', 'scene-5-4', 'scene-5-6', 'scene-5-7', 'scene-5-9', 'scene-5-10',
#         'scene-6-1', 'scene-6-2', 'scene-6-4', 'scene-6-5', 'scene-6-6', 'scene-6-7', 'scene-6-8', 'scene-6-10',
#         'scene-7-1', 'scene-7-2', 'scene-7-3', 'scene-7-4', 'scene-7-6', 'scene-7-7', 'scene-7-8', 'scene-7-9',
#         'scene-8-1', 'scene-8-2', 'scene-8-3', 'scene-8-4', 'scene-8-6', 'scene-8-7', 'scene-8-8', 'scene-8-9',
#         'scene-1-11', 'scene-1-12', 'scene-1-13', 'scene-1-14', 'scene-1-15', 'scene-1-16', 'scene-1-17', 'scene-1-18',
#         'scene-2-12', 'scene-2-13', 'scene-2-14', 'scene-2-16', 'scene-2-17', 'scene-2-18', 'scene-2-19', 'scene-2-20',
#         'scene-3-11', 'scene-3-12', 'scene-3-13', 'scene-3-14', 'scene-3-15', 'scene-3-17', 'scene-3-18', 'scene-3-19',
#         'scene-4-12', 'scene-4-13', 'scene-4-14', 'scene-4-15', 'scene-4-16', 'scene-4-18', 'scene-4-19', 'scene-4-20',
...
# vals = \
#     [
#         'scene-2-5', 'scene-1-9', 'scene-2-1', 'scene-1-10', 'scene-3-6', 'scene-3-10', 'scene-4-1', 'scene-5-5',
#         'scene-4-7', 'scene-5-8', 'scene-6-3', 'scene-6-9', 'scene-7-10', 'scene-7-5',  'scene-2-15', 'scene-1-19',
#         'scene-2-11', 'scene-1-20', 'scene-3-16', 'scene-3-20', 'scene-4-11', 'scene-5-15', 'scene-4-17', 'scene-5-18',
#         'scene-6-13', 'scene-6-19', 'scene-7-20', 'scene-7-15', 'scene-8-10', 'scene-8-5', 'scene-8-20', 'scene-8-15']

test16_val = [
    'scene-2-5', 'scene-3-6', 'scene-4-7', 'scene-5-8', 'scene-6-9', 'scene-7-10']

test16_train = [
    'scene-1-1', 'scene-1-2', 'scene-1-3', 'scene-1-4', 'scene-2-1', 'scene-2-2', 'scene-2-3', 'scene-2-4',
    'scene-3-1', 'scene-3-2', 'scene-3-3', 'scene-3-4', 'scene-3-5', 'scene-4-1', 'scene-4-2', 'scene-4-3',
    'scene-4-4', 'scene-4-5', 'scene-4-6', 'scene-5-1', 'scene-5-2', 'scene-5-3', 'scene-5-4', 'scene-5-5',
    'scene-5-6', 'scene-5-7', 'scene-6-1', 'scene-6-2', 'scene-6-3', 'scene-6-4', 'scene-6-5', 'scene-6-6',
    'scene-6-7', 'scene-6-8', 'scene-7-1', 'scene-7-2', 'scene-7-3', 'scene-7-4', 'scene-7-5', 'scene-7-6',
    'scene-7-7', 'scene-7-8', 'scene-7-9']
...
def create_splits_scenes(verbose: bool = False) -> Dict[str, List[str]]:
    ...
    scene_splits = {'train': train, 'val': val, 'test': test,
                    ...
                    'trains': trains, 'vals': vals, 'test16_val': test16_val, 'test16_train': test16_train}
